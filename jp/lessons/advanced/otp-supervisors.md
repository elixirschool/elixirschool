...
- [設定](#configuration)
  - [戦略](#strategies)
  - [入れ子](#nesting)
- [Taskスーパーバイザ](#task-supervisor)
  - [セットアップ](#setup)
  - [監督されたTask](#supervised-tasks)
...
もしプロセスが停止したり終了させられたりすると、スーパーバイザは何事もなかったかのように自動的にプロセスを再起動するでしょう。
...
もしタスクが途中で停止すると、再起動が行われます。これは次々と入ってくる接続や、バックグラウンド作業の処理を扱う場合には特に役に立つでしょう。
