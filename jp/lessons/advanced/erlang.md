...
- [Erlangパッケージ](#erlang-packages)
- [注目すべき違い](#notable-differences)
  - [アトム](#atoms)
  - [文字列](#strings)
  - [変数](#variables)
...
以前のレッスンでMixと依存関係の管理を扱いましたが、Erlangライブラリを組み込むのも同様の方法で動作します。万が一Erlangライブラリが[Hex](hex.pm)に上がっていない(プッシュされていない)場合には、代わりにgitリポジトリを参照することができます:
