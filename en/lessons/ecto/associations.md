...
We'll start off this lesson by creating a brand new `Example` app, following the same steps from the previous lesson. You can refer to those setup steps [here](../basics) for a quick refresher.
