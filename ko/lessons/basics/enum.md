...
A set of algorithms for enumerating over collection
...
This lesson will only cover a subset of the available functions, to see a complete set of functions visit the official Enum docs; for lazy enumeration use the Stream module.
