...
이 강의의 마지막까지 가는 동안 많은 내장 헬퍼들을 알아보겠습니다.
...
언어의 문서를 1급 클래스처럼 다루는 멋진 기능 덕분에 어떤 코드의 문서도 이 헬퍼를 통해서 바로 접근할 수 있습니다.
간단하게 확인해볼 수 있습니다.
...
모듈에 어떤 함수들이 있는지 확인할 수 있을 뿐만이 아니라, 예제를 포함하는 각 함수의 문서에도 접근할 수 있습니다.
...
이를 통해 Map의 소스코드가 어디에 존재하고 모듈이 어디를 참조하는지를 포함한 많은 정보를 알 수 있습니다. 이는 커스텀 또는 외래 데이터 타입이나 새 함수를 조사할 때 유용합니다.
...
이는 무엇을 해야 할 지를 알려주며, 전혀 모르고 접근하는 것보다도 낫습니다.
...
이제 Map이 구현에서 key와 value 타입을 정의하고 있다는 것을 확인했습니다.
만약 `Map`의 소스를 확인해보면 다음처럼 되어 있을 것입니다.
...
이 멋진 내장 헬퍼들을 통해 코드가 어떻게 동작하는지를 쉽게 확인하고 배울 수 있습니다. IEx는 개발자들을 돕는 매우 강력하고 견고한 도구입니다. 이러한 도구들을 사용하면 조사하고 만드는 것이 좀 더 즐거울 겁니다!
