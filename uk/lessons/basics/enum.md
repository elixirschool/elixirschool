...
Модуль `Enum` включає в себе більш ніж 70 функцій для роботи з перечисленнями.
Всі колекції, про які ми дізналися в [попередньому уроці](../collections/), за виключенням кортежів, є перечисленнями.
...
Перечислення лежить в основі функціонального програмування, і в комбінації з іншими особливостями Elixir може надзвичайно розширити можливості розробника.
...
Вона приймає перечислення і функцію. Коли значення, що повертає функція, змінюється, починається формування нової групи:
