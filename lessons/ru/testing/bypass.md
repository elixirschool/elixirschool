...
Если нужно вспомнить, как это делается, можно заглянуть в раздел [Создание проекта](/ru/lessons/basics/mix#Создание-проекта) соответствующего урока [Mix](/ru/lessons/basics/mix).
