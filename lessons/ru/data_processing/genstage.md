...
Обратное давление перекладывает ответственность на производителя, чтобы не перегружать потребителей, когда они заняты.
...
Мы хотим запрашивать числа от производителя, фильтровать нечетные и реагировать на требования.
...
+ Конвейер преобразования данных — производителям необязательно быть простыми генераторами чисел.
...
Это всего лишь __некоторые__ возможности использования GenStage.
