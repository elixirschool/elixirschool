...
Для добавления нового ключа вместо конструкции `|` используйте [`Map.put/3`](https://hexdocs.pm/elixir/Map.html#put/3), так добавится новый ключ, если он ещё не был добавлен и обновится значение, если такой ключ уже существует. Мы можем увидеть такое поведение, продемонстрированное в нашем примере:
