...
Nós cobrimos brevemente guards nas lições de [Estruturas Condicionais](./control_structures), agora veremos como podemos aplicá-los em funções nomeadas. Uma vez que Elixir tem correspondência em uma função, qualquer guard existente irá ser testado.
