...
চেইঞ্জসেটকে সত্যিকার অর্থে ব্যবহারযোগ্য করতে হলে যখন এটাকে তৈরি করি, তখন আমাদের ডাটা দেখতে কেমন হবে তার একটা নীল নকশা দিয়ে দিতে হবে।
...
এক্টো বলছে, চেইঞ্জসেটটি ভ্যালিড, কিন্তু আসলে আমরা ফাঁকা নাম অনুমোদন করি না, চলুন এটা ঠিক করা যাক!

## ভ্যালিডেশান

ভ্যালিডেশান এর জন্যে এক্টোতে অনেকগুলো বিল্ট-ইন ফাংশন রয়েছে।

আমরা `Ecto.Changeset` বহুলভাবে ব্যবহার করতে যাচ্ছি, তাই আমরা `Ecto.Changeset` কে আমাদের `person.ex` মডিউলে ইম্পোর্ট করবো, যেটাতে আমাদের স্কিমা ও রয়েছে:
