...
দ্রষ্টব্য: `iex` এ কাজ করার সময় `recompile()` রান করতে ভুলবেন না, না হলে কোডের পরিবর্তনগুলো দেখতে পাবেন না।
...
এরর মেসেজে বিদঘুটে `%{count}` দেখে হয়তো আপনি আশ্চর্য হচ্ছেন। এটা অন্যান্য ভাষায় অনুবাদ করা সহজ করে। আপনি যদি সরাসরি ইউজারকে এরর দেখাতে চান, সেক্ষেত্রে আপনি এটাকে [`traverse_errors/2`](https://hexdocs.pm/ecto/Ecto.Changeset.html#traverse_errors/2) ব্যবহার করে মানুষের পড়ার উপযুক্ত করতে তুলতে পারেন — ডকুমেন্টে উল্লেখিত উদাহরণটি দেখে নিন।
...
`name` ফিল্ডটিকে রিকয়ার্ড না করে, চলুন ইউজারকে নাম ছাড়াই সাইন আপ করার সুযোগ দিই, এবং তাদের "Anonymous" নামে ডাকি।
...
কিছু নির্দিষ্ট দায়িত্ব পালন করে এমন ক্রিয়েটর ফাংশন (যেমন `registration_changeset/2`) অহরহই দেখা যায় — অনেক সময় আপনার কিছু নির্দিষ্ট ভ্যালিডেশান করতে হতে পারে অথবা নির্দিষ্ট প্যারামিটার ফিল্টার করার সক্ষমতা লাগতে পারে।
