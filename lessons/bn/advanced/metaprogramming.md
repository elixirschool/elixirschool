...
লক্ষ্য করেছেন কি, প্রথম তিনটি কেন টাপল রিটার্ন করেনি? সর্বমোট পাঁচটি লিটারেল আছে যেগুলো যখন কো'ট করা হয় তখন টাপল রিটার্ন করে না:
...
আমরা কিভাবে কোড এর অভ্যন্তরীণ কাঠামো পেতে হয় তা শিখলাম, কিন্তু আমরা এটাকে কিভাবে পরিবর্তন করতে পারি? নতুন কোন ভ্যালু অথবা নতুন কোড যোগ করতে আমরা `unquote/1` ব্যবহার করি।
...
যেহেতু, ম্যাক্রো আমাদের এপ্লিকেশান কোড এর পরিবর্তে বসে, কখন এবং কি কম্পাইল হবে তা আমরা নিয়ন্ত্রণ করতে পারি।
...
এটা দেখতে, আমরা একটা একদম সাদামাটা লগার তৈরি করবো, যেটা চালু অথবা বন্ধ করা যাবে:
...
কিন্তু, কেমন হবে যদি আপনার কোনো অনেক বড় সাইজের একটা কো'ট করা কোড বুঝতে হয়? এক্ষেত্রে, আপনি `Macro.to_string/2` ব্যবহার করতে পারেন।
...
এখানে, প্রথমটি ক্ষেত্রবিশেষে কয়েকবার রূপান্তর করে, কিন্তু পরেরটি শুধুমাত্র একবার।
...
যদিও এটা প্রচলিত নয়, তবে, এলিক্সির কিন্তু  প্রাইভেট ম্যাক্রোও সাপোর্ট করে।
...
আসুন, তারা কিভাবে কন্টেক্সট এর সাথে কিভাবে ইণ্টারেক্ট করে তা তুলনা করা যাক:
