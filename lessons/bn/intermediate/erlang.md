%{
  ...
  excerpt: """
  এরল্যাং ভি এম (BEAM) এর উপর তৈরি হওয়ার অন্যতম সুবিধা হলো, আমাদের কাছে হাজারো লাইব্রেরী ব্যবহার করার সুযোগ করে দেয়া।
  ইন্টারোপারেবিলিটি আমাদের সে সমস্ত লাইব্রেরী ও এরল্যাং এর স্ট্যান্ডার্ড লাইব্রেরী গুলো এলিক্সির কোড থেকে ব্যবহার করতে দেয়।
  এই অধ্যায়ে, আমরা দেখবো কিভাবে স্ট্যান্ডার্ড ও থার্ড পার্টি এরল্যাং প্যাকেজ এর ফাংশনালিটি এক্সেস করতে হয়।
  """
}
---
...
আমাদের অ্যাপ্লিকেশানের এলিক্সির কোড থেকে এরল্যাং এর বৃহৎ স্ট্যান্ডার্ড লাইব্রেরী এক্সেস করা যায়।
এরল্যাং এর মডিউল গুলো ছোট হাতের এটম দিয়ে প্রকাশ করা হয় যেমনঃ `:os` এবং `:timer`।
...
আরও কি কি মডিউল আছে তার সম্পূর্ণ লিস্ট পেতে দেখুন এরল্যাং এর [রেফারেন্স ম্যানুয়াল](http://erlang.org/doc/apps/stdlib/)।

## এরল্যাং প্যাকেজ

আগের অধ্যায়ে আমরা মিক্স এবং ডিপেন্ডেসী ম্যানেজমেন্ট শিখেছি।
এরল্যাং এর  লাইব্রেরী গুলোও একই ভাবে কাজ করে।
যদি এরল্যাং এর লাইব্রেরীটি [হেক্স](https://hex.pm) এ পুশ করা না থাকে, তাহলে এর পরিবর্তে গিট রিপোজিটরী ও ব্যবহার করা যায়ঃ
...
তাদেরকে ছোট হাতের অক্ষর ও আন্ডারস্কোর ব্যবহার করে লেখা হয়ঃ
...
যখন আমরা এলিক্সিরে স্ট্রিং নিয়ে আলোচনা করি তখন আমরা শুধু মাত্র UTF-8 এনকোডেড বাইনারীই বুঝি।
