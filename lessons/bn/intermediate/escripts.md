%{
  ...
  এরল্যাং ইন্সটল করা থাকলেই, ই-স্ক্রিপ্ট দিয়ে তৈরি করা এক্সিকিউটেবল যেকোনো সিস্টেমে রান করা যায়।
  """
}
---
...
ই-স্ক্রিপ্ট দিয়ে এক্সিকিউটেবল তৈরি করার জন্যে আমাদেরকে শুধুমাত্র কয়েকটা জিনিস করতে হবেঃ `main/1` ফাংশন ইমপ্লিমেন্ট করা এবং মিক্সফাইল আপডেট করা।
...
এর জন্যে, আমরা এলিক্সির এর `OptionParser.parse/2` ফাংশনটি ব্যবহার করবো এবং এর সাথে `:switches` অপশনটি যুক্ত করবো যাতে করে আমাদের ফ্ল্যাগ বুলিয়ান তা নির্দেশ করা যায়ঃ
