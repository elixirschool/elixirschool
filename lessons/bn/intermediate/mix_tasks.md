...
নিজস্ব কাস্টম মিক্স টাস্ক দিয়ে এলিক্সির এপ্লিকেশন এর ফাংশনালিটি বাড়ানো বেশ জনপ্রিয়।
এই অধ্যায়ে আমরা কিভাবে আমাদের প্রয়োজন অনুযায়ী মিক্স টাস্ক তৈরি করতে হয় তা জানবো তার আগে, প্রচলিত কিছু মিক্স টাস্কের উদাহরণ দেখা যাকঃ
...
উপরের শেল কমান্ড থেকে আমরা দেখতে পাচ্ছি যে, ফিনিক্স ফ্রেইমওয়ার্ক কাস্টম মিক্স টাস্ক দিয়ে প্রজেক্ট তৈরির কাজটি করে থাকে।
আমরা যদি আমাদের প্রোজেক্টের জন্য এমন কিছু করি তাহলে কেমন হয়? এলিক্সির মিক্স ট্যাস্ক দিয়ে এ ধরনের কাজ করতে দেয় খুব সহজেই।
...
২য় লাইনে, `use Mix.Task` এর মাধ্যমে `Mix.Task` বিহেভিয়রকে আমাদের নেইমস্পেইসে আনা হয়।
এর পরে, আমরা `run` ফাংশনটি বানাই যা (আপাতত) কোন আর্গুমেন্ট নেয় না।
...
মানুষ মাত্রই ভুল এটা সে জানে, কাজেই যদি কখনো বানান ভুল করেন আপনার কমান্ডটি লিখার সময় তাহলে ফাজি স্ট্রিং ম্যাচিংয়ের মাধ্যমে আপনাকে মিক্স রিকমেন্ড করবে যেমন-
