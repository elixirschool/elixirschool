...
ইনাম `Enum` মডিউলে প্রায় ৭০ টার উপরে ফাংশন আছে যা দিয়ে কালেকশন এর সাথে কাজ করা যায়। টাপল বাদে [আগের অধ্যায়ে](/bn/lessons/basics/collections) আমরা যতগুলি কালেকশন নিয়ে কথা বলেছি, তার সবগুলিই ইনিউমেরবল।
...
`chunk_every` এর আরও কিছু অপশন আছে, কিন্তু আমরা সেগুলোতে আমরা এখন নাই যাই, আপনারা সেগুলো দেখে নিতে পারবেন এখানে,[`chunk_every/4`](https://hexdocs.pm/elixir/Enum.html#chunk_every/4) এই অফিসিয়াল ডকুমেন্ট এ ।
...
কিছু উদাহরন থাকল কিভাবে ক্যাপচার অপারেটর সহ ইনাম মডিউল ব্যবহার করতে হয়।
