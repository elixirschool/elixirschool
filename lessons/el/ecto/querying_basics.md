...
Ερωτήματα σαν και αυτό ονομάζονται _λυμένα_ επειδή είναι αρκετά απλά ώστε να μην απαιτούν δεσίματα.
...
Σε τέτοιες περιπτώσεις, καλούμε τη μεταβλητή `m` _δέσιμο_.
...
Χρησιμοποιώντας μια _έκφραση_ με ένα δέσιμο στο μέρος της `select:` μας επιτρέπει να ορίζουμε ακριβώς τον τρόπο που επιστρέφονται τα επιλεγμένα πεδία.
...
Στα παραδείγματα πιο πάνω χρησιμοποιήσαμε λέξεις κλειδί όπως οι `select:` και `where:` μέσα στη μακροεντολή `from` για να χτίσουμε ένα ερώτημα - αυτά ονομάζονται _ερωτήματα βασισμένα σε λέξεις κλειδιά_.
...
Κάθε μακροεντολή δέχεται μια _ερωτήσιμη_ τιμή, _μια σαφή λίστα δεσιμάτων_ και την ίδια έκφραση που θα παρείχατε στην αντίστοιχη λέξη κλειδί:
