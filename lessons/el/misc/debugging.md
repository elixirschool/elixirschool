...
Πιθανότατα έχετε ήδη συναντίσει το IEx σε ένα από τα προηγούμενα μαθήματα όπως το [Βασικά](/el/lessons/basics/basics) όπου ο κώδικας Elixir εκτελείται διαδραστικά στο κέλυφος.
