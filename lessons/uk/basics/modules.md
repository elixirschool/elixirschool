...
Крім групування функцій, вони дозволяють визначати іменовані і приватні функції, які ми розглянули в [уроці про функції](/uk/lessons/basics/functions).
...
Продовжуючи вивчати Elixir, звертайте увагу на `use`. Приклад, який точно трапиться на шляху — це `use ExUnit.Case, async: true`.

**Примітка**: макроси `quote`, `alias`, `use`, `require` використовуються при роботі з [метапрограмуванням](/uk/lessons/advanced/metaprogramming).
