...
Hemos cubierto brevemente las guardias en la lección [Estructuras de control](./control_structures), ahora veremos cómo aplicarlas a las funciones con nombre. Una vez Elixir ha coincidido una función algunas guardias serán evaluadas.
