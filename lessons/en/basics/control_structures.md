...
Check the official docs for [Expressions allowed in guard clauses](https://hexdocs.pm/elixir/main/patterns-and-guards.html#list-of-allowed-functions-and-operators).
