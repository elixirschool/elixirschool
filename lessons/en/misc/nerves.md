...
To write embedded code using Nerves, you will need one of the [supported targets]([https://hexdocs.pm/nerves/targets.html](https://hexdocs.pm/nerves/supported-targets.html), a card reader with a memory card supported by the hardware of your choice, as well as wired networking connection to access this device by the network.
