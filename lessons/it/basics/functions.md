...
Abbiamo trattato brevemente le guadie (_guards_) nella lezione sulle [Strutture di Controllo](./control_structures), ora vedremo come possiamo applicarle alle funzioni con un nome. Una volta che Elixir ha individuato una funzione, tutte le guardie verranno controllate.
