...
*주의*: Mix 프로젝트 컨텍스트 내에서 작업한다면 파일 컴파일을 위에서 처럼 수동으로 할 필요는 없습니다. Mix 프로젝트에서는 `iex -S mix`를 사용하여 현재 프로젝트의 IEx 콘솔을 로드할 수 있습니다.
...
**Note:** `@spec` 어노테이션은 코드의 정적 분석에 사용됩니다. 여기에 대해 배우려면, [사양과 타입](/ko/lessons/advanced/typespec) 강의를 확인하세요.
