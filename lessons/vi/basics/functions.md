...
Ta đã xem sơ qua guards trong bài [Cấu trúc điều khiển](/vi/lessons/basics/control_structures), giờ ta sẽ xem cách chúng ta áp dụng chúng cho hàm được đặt tên.  Một khi Elixir so trùng được một hàm các guard sẽ được kiểm tra.
