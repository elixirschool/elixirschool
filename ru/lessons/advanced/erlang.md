...
Совместимость позволяеят нам использовать все эти библоитеки (включая стандартную библиотеку Erlang) в нашем коде на Elixir.
В этом уроке мы рассмотрим как получить доступ использовать стандартную библиотеку Erlang и сторонние пакеты Erlang.
...
Теперь мы можем использовать эти библиотеку Erlang:
