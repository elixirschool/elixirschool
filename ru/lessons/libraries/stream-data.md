...
Если вам нужна помощь, обратитесь к [Создание проекта](https://elixirschool.com/ru/lessons/basics/mix/#%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D0%B5-%D0%BF%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D0%B0).
...
Чтобы проиллюстрировать функционал StreamData, мы напишем несколько простых функций, которые повторяют значения.
...
... но это использует реализацию функции под тестированием, что не имеет смысла.
...
В действительности мы хотим проверить две вещи:
...
Это - применение паттерна, который Scott Wlaschin называет ["Разные Пути, Одна Цель"](https://fsharpforfunandprofit.com/posts/property-based-testing-2/#different-paths-same-destination).
...
Также мы имеем несколько тестов, основанных на свойствах, которые дают нам высокую степень уверенности в правильности нашей реализации.
...
Даже не смотря на это, тестирование на основе свойств - это отличное дополнение к модульному тестированию, основанному на примерах.
Оно позволяет писать короткие тесты, которые покрывают широкий спектр входных данных.
Если у вас нет нужды сохранять состояние между запусками тестов, StreamData предлагает удобный синтаксис для написания тестов на основе свойств.
