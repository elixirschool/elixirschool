...
![Скриншот отладчика 1]({% asset_path "debugger_1.png" %})

После того, как мы подключили наш модуль к отладчику, он появится в меню слева:

![Скриншот отладчика 2]({% asset_path "debugger_2.png" %})
...
![Скриншот отладчика 3]({% asset_path "debugger_3.png" %})

Также появится дополнительное окно с нашим исходным кодом:

![Скриншот отладчика 4]({% asset_path "debugger_4.png" %})
