...
```
  ...
  - Если нет планов документировать этот модуль - не стоит оставлять его незадокументированным. Лучше документировать его как `false`:
...
```
 ...
 - При отсылке к функции внутри документации, стоит использовать лапки:
