...
Кодовые точки &mdash; это просто символы Unicode, которые могут быть представлены одним или двумя байтами. Например, символы с тильдой или акцентами: `á, ñ, è`. Графема состоит из нескольких кодовых точек и выглядит как простой символ.
