...
Строки, списки символов, графемы и кодовые точки.
...
## Графемы и кодовые точки

Кодовые точки &mdash; это просто символы Unicode, которые представлены одним или более байтами в зависимости от кодировки UTF-8. Символы, не входящие в набор US ASCII всегда кодируются более, чем одним байтом. Например, латинские символы с тильдой или акцентами: `á, ñ, è` обычно закодированы двумя байтами. Символы из азиатских языков, как правило, закодированы тремя-четырьмя байтами. Графема состоит из нескольких кодовых точек и выглядит как один символ.
