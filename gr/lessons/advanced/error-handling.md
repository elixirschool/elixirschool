...
* Για σφάλματα που είναι κομμάτι της κανονικής λειτουργίας μια συνάρτησης (π.χ. κάποιος χρήστης εισήγαγε λάθος τύπο ημερομηνίας), η συνάρτηση επιστρέφει '{:ok, result}' και '{:error, reason}' αντίστοιχα.
