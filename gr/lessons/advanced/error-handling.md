...
Σε γενικές γραμμές, η διαχείριση των σφαλμάτων γίνεται με [Pattern Matching](../../basics/pattern-matching/), αλλά σε αυτό το μάθημα, θα επικεντρωθούμε στο δεύτερο σκέλος των Γενικών συμβάσεων - τις εξαιρέσεις.
