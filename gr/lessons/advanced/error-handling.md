...
Σε γενικές γραμμές, η διαχείρηση των σφαλμάτων γίνεται με [Pattern Matching](../../basics/pattern-matching/), αλλά σε αυτό το μάθημ, θα επικεντρωθούμε στο δεύτερο σκέλος των Γενικών συμβάσεων- τις εξαιρέσεις.
