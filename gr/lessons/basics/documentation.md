...
Για να μάθετε περισσότερα για αυτό, επισκεφτείτε το μάθημα [Specifications and types](../../advanced/typespec).
...
Μέσα στο αρχείο `mix.exs` προσθέστε τις δύο απαιτόυμενες εξαρτήσεις για να ξεκινήσετε: `:earmark` και `:ex_doc`.
...
Είναι σημαντικό να σημειώσουμε σε αυτό το σημείο ότι δεν είστε υποχρεωμένοι να χρησιμοποιήσετε το Earmark.  Μπορείτε να αλλάξετε το εργαλείο σήμανσης με άλλα όπως το Pandoc, το Hoedown ή το Cmark.  Πάντως θα χρειαστείτε να κάνετε λίγες παραπάνω ρυθμίσεις για τις οποίες μπορείτε να διαβάσετε [εδώ](https://github.com/elixir-lang/ex_doc#changing-the-markdown-tool).
...
```
 ...
 - Χρησιμοποιήστε markdown μέσα στις συναρτήσεις.
