...
**Σημείωση:** Χρησιμοποιεί [αυστηρή σύγκριση](../basics/#comparison) για να ταιριάξει τις τιμές.
...
Επιπρόσθετα στις προαναφερθείσες συναρτήσεις, μπορείτε να χρησιμοποιήσετε [ταιριάσματα προτύπων](../pattern-matching/) και τον τελεστή σωλήνα `|` για να χωρίσετε μια λίστα στην κεφαλή και την ουρά.  Θα μάθουμε περισσότερα για αυτό το πρότυπο σε μεταγενέστερα μαθήματα:
