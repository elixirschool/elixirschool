...
Ένα άτομο είναι μια σταθερά της οποίας το όνομα είναι και η τιμή της.  Αν είστε εξοικιωμένοι με την Ruby, τα άτομα είναι συνόνυμα με τα Σύμβολα:
...
Η Elixir υποστηρίζει τους βασικούς τελεστές `+`, `-`, `*`, και `/`, όπως θα περιμένατε.  Είναι σημαντικό να παρατηρήσουμε ότι ο τελεστής `/` πάντα επιστρέφει αριμό κινητής υποδιαστολής:
...
Αν χρειάζεστε ακέραια διαίρεση ή το υπόλοιπο της διαίρεσης, η Elixir περιέχει δύο χρήσιμες συναρτήσεις για να το επιτύχει:
...
Η Elixir παρέχει τους δυαδικούς τελεστές `||`, `&&` και `!`.  Αυτοί υποστηρίζουν όλους τους τύπους:
