...
Ίσως να μην το έχετε συνειδητοποιήσει, αλλά μια εφαρμογή Elixir διατηρεί κάποια κατάσταση στην διαμόρφωσή της.
Αντί να γράψουμε μια ενότητα ή να την περάσουμε ως όρισμα, μπορούμε να την προσπελάσουμε από το αρχείο διαμόρφωσης της εφαρμογής.
...
Παρ' όλα αυτά, το να έχουμε μόνο μια καθορισμένη ενότητα ανά περιβάλλον μπορεί να μην παρέχει αρκετή ευελιξία: εξαρτάτε από την χρήση της συνάρτησής σας, μπορεί να χρειάζεται να επιστρέψετε διαφορετικές απαντήσεις ώστε να είστε σε θέση να δοκιμάσετε όλες τις πιθανές εκβάσεις της εκτέλεσης.
...
Αρχικά, δεν υπάρχει τίποτα που να εγγυάτε πως οι ενότητες που προσδιορίζουμε για την `:http_client` μπορούν να κάνουν αυτό που προορίζοντε: δεν υπάρχει κάποια απαίτηση από τις ενότητες να συμπεριλαμβάνουν μια συνάρτηση `get/1`.
...
Το δεύτερο ζόρικο κομμάτι είναι ότι η ενότητα στην οποία αναφερόμαστε με το `for:` _πρέπει_ να είναι συμπεριφορά: _πρέπει_ να προσδιορίζει ανακλήσεις.
...
μερικές φορές μπορεί να είναι δύσκολο να βρείτε την ενότητα συμπεριφοράς: η `HTTPoison` για παράδειγμα, βασίζεται στην `HTTPoison.Base`, αλλά μπορεί να μην το γνωρίζετε αυτό αν δεν δείτε τον πηγαίο κώδικά της.
