...
Αν είστε εξοικειομένοι με τη Ruby μπορείτε να σκεφτείτε το Plug σαν το Rack με λίγο Sinatra.  Παρέχει εναν προσδιορισμό για στοιχεία εφαρμογών web και αντάπτορες για εξυπηρετητές web.  Παρόλο που δεν είναι μέρος της πυρήνα της Elixir, είναι ένα επίσημο Elixir project.
...
_Σημείωση_: Τα Plugs εφαρμόζονται σε όλες τις αιτήσεις, γιαυτό θα φιλτράρουμε τις αιτήσεις και θα εφαρμόσουμε τη λογική μας σε ένα υποσύνολο αυτών.  Για να αγνοήσουμε μια αίτηση απλά μεταφέρουμε την αίτηση.
...
defmodule Example.Plug.VerifyRequest do
  ...
  defmodule IncompleteRequestError do
    @moduledoc """
    Σφάλμα προκλήθηκε όταν ένα απαιτούμενο πεδίο λείπει
    """
