...
Ας δούμε αυτό το plug εν λειτουργία!
...
Η `handle_errors/2` απλά πρέπει να δεχθεί το `conn` ως το πρώτο όρισμα και κατόπιν έναν χάρτη με τρια αντικείμενα (άτομα;;;;) (`:kind`, `:reason`, and `:stack`) ως δεύτερο όρισμα.
