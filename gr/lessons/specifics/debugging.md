...
Πιθανότατα έχετε ήδη συναντίσει το IEx σε ένα από τα προηγούμενα μαθήματα όπως το [Basics](../../basics/basics) όπου ο κώδικας Elixir εκτελείται διαδραστικά στο κέλυφος.
...
Αφού δώσυμε την απάντηση `y` στην ερώτηση (Allow? [Yn]) ή πατώντας Enter, μπαίνουμε στην διαδραστική μορφή.
...
Για να βγούμε από το περιβάλον του IEx, είσαγουμε τους χαρακτήρες `Ctrl+C` δύο φορές, ή πληκτρολογούμε `continue` για να περάσουμε στο επόμενο σημείο διακοπής.

Όπως μπορείτε να δείτε, μπορείτε να εκτελέσετε κώδικα Elixir.

Παρ'ολ'αυτά, ο περιορισμός είναι ότι δεν μπορούμε να αλλάξουμε μεταβλητές του υπάρχοντα κώδικα, εξ'αιτίας της αμεταβλητότητας της γλώσσας.

Παρ'ολ'αυτά, μπορείτε να πάρετε τιμές για όλες τις μεταβλητές και να τρέξετε οποιονδήποτε υπολογισμό.
