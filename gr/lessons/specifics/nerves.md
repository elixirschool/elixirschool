...
Για να ενημερώσετε την εγκατάσταση σας, ο πιο απλός τρόπος είναι να χρησιμοποιήσετε την εντολή `mix firmware && ./upload.sh 192.168.88.2`: η πρώτη εντολή δ ημιουργεί το ενημερωμένο υλικολογισμικό, και η δεύτερη το προωθεί μέσω του δικτύου και επανεκκινεί την συσκευή.
