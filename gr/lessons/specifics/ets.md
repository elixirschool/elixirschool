...
Αν περισσότερες απο μια διεργασία έχουν δικαιώματα εγγραφής σε έναν πίνακα - είτε μεσω πρόσβασης από την `:public` είτε από μηνύματα στην ιδιοκτήτρια διεργασία - οι συνθήκες αγώνα είναι πιθανές.
...
Για τους μετρητές συγκεκριμένα, [:ets.update_counter/3](http://erlang.org/doc/man/ets.html#update_counter-3) παρέχει για ατομική ενημέρωση-και-ανάγνωση.
