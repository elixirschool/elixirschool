...
Η ύπαρξη συναρτήσεων δημιουργίας σετ αλλαγών που έχουν μία συγκεκριμμένη αρμοδιότητα (όπως η `registration_changeset/2`) είναι συνηθισμένη - μερικές φορές χρειαζόμαστε την ελαστικότητα να εκτελούμε συγκεκριμμένες επικυρώσεις ή να φιλτράρουμε συγκεκριμμένες παραμέτρους.
