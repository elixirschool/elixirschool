...
* Αποθετήριο - παρέχει τη διεπαφή στη βάση δεδομένων μας, συμπερλιλαμβανομένης της σύνδεσης
...
Κάθε μετατροπή περιγράφει ένα σύνολο δράσεων που θα γίνουν στη βάση δεδομένων μας, όπως ποιόν πίνακα να δημιουργήσει ή να αλλάξει.
