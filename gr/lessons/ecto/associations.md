...
Σε αυτό τον τομέα θα μάθουμε πως να χρησιμοποιήσουμε το Ecto για να ορίσουμε και να εργαστούμε με συσχετίσεις ανάμεσα στα σχήματά μας.
...
Θα ξεκινήσουμε με τύο σχήματα: Τα `Movie` και `Character`.
...
Τώρα είμαστε έτοιμοι να χτήσουμε τη μετατροπή και το σχήμα για το `Character`.
...
Παρόμοια το σχήμα μας χρειάζεται να ορίσουμε τη σχέση "ανήκει σε" ανάμεσα σε ένα χαρακτήρα και την ταινία του.
...
Θα ορίσουμε τη μετατορπή μας ώστε να έχει δύο ξένα κλειδιά.
...
* Η δομή της εγγραφής που θέλουμε να αποθηκεύσουμε.
...
Τώρα θα χτίσουμε ένα συσσχετιζόμενο χαρακτήρα και θα τον εισάγουμε στη βάση δεδομένων:
...
Για να μπορέσουμε να αποθηκεύσουμε το διανομέα μιας ταινίας, θα έχουμε την ίδια προσέγγιση περνώντας το _όνομα_ της σχέσης της ταινίας με το διανομέα σαν δεύτερο όρισμα της `build_assoc/3`:
...
Θα μιλήσουμε περισσότερο για την προφόρτωση δεδομένω σε λίγο.
...
Στην επόμενη ενότητα, θα μάθουμε πως να δημιουργούμε ερωτήματα των συσχετιζόμενων εγγραφών μας.
