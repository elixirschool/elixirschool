...
Podemos usar `uniq_by/2` para eliminar duplicados de nuestras colecciones y ordenar los elementos si es que estos fuesen datos primitivos de tipo Integer:
